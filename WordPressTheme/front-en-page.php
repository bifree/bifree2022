<?php get_header(); ?>
    <main>
                        ...
                        <div class="top-service__list_text">
                            <div class="top-service__list_top">
                                ...
                                <div class="top-service__list_title">
                                    <p class="service_title_en">ウェブ制作</p>
                    ...
                    <li class="top-service_list_item top-service__list_media">
                        <div class="top-service__list_text">
                            <div class="top-service__list_top">
                                ...
                                <div class="top-service__list_title">
                                    <p class="service_title_en">メディア運営</p>
                    ...
                    <li class="top-service_list_item top-service__list_edu">
                        <div class="top-service__list_text">
                            <div class="top-service__list_top">
                                ...
                                <div class="top-service__list_title">
                                    <p class="service_title_en">LGBT啓蒙活動</p>
        ...
        <section class="top-article" id="article">
            ...
            <div class="_container">
                <p class="bigger _center">Now preparing..</p>
            </div>
        ...
        <section class="top-contact" id="contact">
            ...
            <div class="_container">
                <p class="_center">Please feel free to contact us for<br class="sp-block"> job requests, questions and consultations.</p>
                <div class="top-form">
                ...
                <div class="company_inner _flex">
                    <table class="company_table">
                        <tbody>
                            <tr>
                                <td>Company Name</td>
                                <td>The limited liability company Bifree</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Address</td>
                                <td>2-2-15 Minami Aoyama, Minato-ku, Tokyo</td>
                            </tr>
                            <tr>
                                <td>CEO</td>
                                <td>Masaki Aihara</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Website construction business <br>
                                    Web system construction business <br>
                                    Web media management business <br>
                                    Programmer training business <br>
                                    Awareness-raising activities regarding LGBTQ
                                </td>
                            </tr>
                            <tr>
                                <td>Main Bank</td>
